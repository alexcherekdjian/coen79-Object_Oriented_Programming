...
//
// DYNAMIC MEMORY usage by the sequence class: The sequence class dynamically
// allocates memory through the node toolkit. The functions that will allocate
// memory are the following: insert, attach, and operator =
